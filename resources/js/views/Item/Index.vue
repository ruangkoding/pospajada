                ...
                <div class="card">
                    <div class="card-header">
                        <div :class="{ 'pull-right': mobile === false }">
                            <button type="button" v-on:click.prevent="toggle" :class="{ 'btn-block': mobile === true }"
                                class="btn btn-outline-info mb-2">
                                <i class="fa fa-search"></i> Form Pencarian
                            </button>
                            <a v-if="access.write === 1" :href="route + '/create'"
                                :class="{ 'btn-block': mobile === true }" class="btn btn-success mb-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="text-align: center;">
                                            <a
                                                ...
                                                class="btn btn-sm btn-block btn-outline-warning mr-sm-1">
                                                <i class="fa fa-wrench"></i> Ubah
                                            </a>
                                            <button
                                                v-else
                                                class="btn btn-sm btn-block btn-outline-warning disabled mr-sm-1">
                                                <i class="fa fa-wrench"></i> Ubah
                                            </button>
                                            <a

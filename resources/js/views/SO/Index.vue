                        ...
                        <div class="card-body">
                            <table class="table-noborder">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <router-link :to="{ name: 'so.detail', params: { id: v.id} }">  
                                            {{ v.so_number }}
                                        </router-link>
                                    </td>
                                </tr>
                ...
                <div class="table-responsive" v-else>
                    <table class="table table-hover table-striped table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col" style="text-align:center;">Nomor Order</th>
...
export default {
    ...
    methods: {
        ...
        fetchData() {
            ...
            service.fetchData('/api/so?user=' + this.userid + '&'+ query + '&page='+ this.pagination.page)
            .then(ressonse => {

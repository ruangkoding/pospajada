                    ...
                    <form v-on:submit.prevent="fetchData()">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <input type="text" class="form-control" v-model="search.q" placeholder="Username / Nama Pengguna" />
                            </div>
                            <div class="form-group col-md-4">
                ...
                <div v-if="mobile === true">
                    <div class="card" v-for="v in user" :key="v.id">
                        <div class="card-body">
                            ...
                            <div class="summary">
                                <span class="buttons">
                                    <router-link :to="{ name: 'user.edit', params: { id: v.id} }" class="btn btn-sm btn-outline-warning mr-2">  
                        ...
                        <table class="table table-bordered" style="min-width: 100%">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" class="text-center" style="width:20%;">Cabang Bisnis</th>
                                    <th scope="col" class="text-center" style="width:20%;">Jabatan</th>
                                ...
                                <tr v-for="v in user" :key="v.id">
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <router-link :to="{ name: 'user.edit', params: { id: v.id} }" class="btn btn-sm btn-warning mr-2">  
                                                <i class="fa fa-wrench"></i> Ubah
                                            </router-link>
                                            <a 
                                                href="#" 
                                                ...
                                                <i class="fa fa-trash-o"></i> Non Aktifkan
                                            </a>
                                        </div>
                                    </td>
                                </tr>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData() {
                ...
                service
                    .fetchData("/api/user?" + query + "&page=" + this.pagination.page)
                    .then((response) => {
            ...
            deleteData(id) {
                service.deleteData("/api/user?id=" + id)
                .then(response => {
                    if(response.status === 'ok') {
                        $('#delete_modal').modal('hide');
                        this.$swal("Berhasil!", "Pengguna Berhasil Dinonaktifkan!", "success");
                        this.fetchData();

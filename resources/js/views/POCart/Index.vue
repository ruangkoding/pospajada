                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input 
                                                        ...
                                                        :class="{ 'is-invalid': validasi.po_number }">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-12">
...
<script>
    ...
    export default {
        ...
        props: ['supplier', 'api', 'route', 'access', 'mobile'],
        methods: {
            calcChanges() {
            ...
            validate() {
                ...
                if (this.checkout.supplier_id.length === 0) {
                    this.validasi.supplier_id = true;
                    condition++;
                } else {
                    this.validasi.supplier_id = false;
                }

                if (this.checkout.po_number.length === 0) {
                    this.validasi.po_number = true;
                    condition++;
                } else {
                    this.validasi.po_number = false;
                }

                if (this.checkout.po_date.length === 0) {
                    this.validasi.po_date = true;
                    condition++;
                } else {
                    this.validasi.po_date = false;
                }

<template>
    <div class="card">
        <div class="card-header">
            ...
            <div class="card" style="margin-top:50px;" v-if="showForm">
                <div class="card-body">
                ...
                <div v-if="mobile === true">
                    <div class="card" v-for="v in customer" :key="v.id">
                        <div class="card-body">
                            ...
                            <div class="summary">
                                <span class="buttons">
                                    <router-link :to="{ name: 'customer.edit', params: { id: v.id} }" class="btn btn-outline-warning mr-2">  
                            ...
                            <tr v-for="v in customer" :key="v.id">
                                ...
                                <td>
                                    <div style="text-align: center;">
                                        <router-link :to="{ name: 'customer.edit', params: { id: v.id} }" class="btn btn-sm btn-warning mr-2">  
                                        <i class="fa fa-wrench"></i> Ubah
                                    </router-link>
                                    <a
                                        href="#"
...
export default {
    ...
    methods: {
        ...
        fetchData() {
            ...
            service.fetchData('/api/customer?'+ query + '&page='+ this.pagination.page)
            .then(response => {
        ...
        deleteData(id) {
            service.deleteData('/api/customer?id=' + id)
            .then(response => {

                                    ...
                                    <form v-on:submit.prevent="fetchData()">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <input type="text" class="form-control" v-model="search.q" placeholder="Nama Customer">
                                            </div>
                        ...
                        <transition name="fade" v-if="mobile === true">
                            <div v-if="showTable === true">
                                <div class="card" v-for="v in customer" :key="v.id">
                                  <div class="card-body">
                                    <h5 class="card-title">{{ v.customer_name }}</h5>
                                    <br>
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width:2%;">:</td>
                                                <td style="width:50%;">{{ v.customer_address }}</td>
                                            </tr>
                                            <tr>
                                                <td style="width:5%;">Kontak</td>
                                                <td style="width:2%;">:</td>
                                                <td style="width:50%;">{{ v.hp }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <br>
